    ...
    return(
        ...
        <section id='contact' className='lg:px-[50px] px-[20px] pt-[20px] mt-[2rem] lg:pb-[20px] pb-[20px]'>
            ...
            <div className="py-[1rem] xui-row xui-flex-ai-flex-start">
                ...
                <div className="xui-lg-col-8 xui-col-12 flex items-center justify-between lg:mt-[0] mt-[1rem]">
                    <HashLink className='lg:text-[90%] text-[70%] font-medium' smooth to='#about'>About us</HashLink>
                    <HashLink className='lg:text-[90%] text-[70%] font-medium' smooth to='#social-categories'>Social categories</HashLink>
                    <HashLink className='lg:text-[90%] text-[70%] font-medium' smooth to='#recipes'>Video recipe cards</HashLink>
                </div>
            </div>
            </div>
