...
import Variety1 from "../../assets/images/variety-1.jpg";
import Variety2 from "../../assets/images/variety-2.jpg";
...
export default function Varieties(){
    ...
    return(
        <>
        <section className='lg:pl-[50px] bg-[#F9F9F9] pl-[20px] pt-[50px] lg:pb-[170px] pb-[60px]'>
            <div className='text-black pl-[20px] py-[50px] rounded-[12px]'>
                <div className='flex flex-wrap justify-between pr-[50px]'>
                    <div data-aos="fade-right" data-aos-duration="800" className='lg:w-[calc(100%-200px)] w-full'>
                        ...
                        <h1 data-aos="fade-down" data-aos-delay="400" data-aos-duration="800" className='text-[170%] xui-font-9'>Explore a Variety of Choices</h1>
                    </div>
                ...
                <div className='flex flex-wrap py-[35px] items-flex-end'>
                    <div data-aos="fade-right" data-aos-duration="800" className='basis-[20%] custom-holder'>
                        <h3 data-aos="fade-down" data-aos-delay="400" data-aos-duration="800" className='text-[120%] xui-font-9'>Our Product Categories</h3>
                    ...
                    >
                        <SwiperSlide>
                            <div className="bg-cover bg-center flex w-full h-full rounded-[12px] pt-[180px] pl-[50px]  pb-[60px]"
                             style={{backgroundImage: `url(${Variety1})`}}>

                            </div>
                        </SwiperSlide>
                        <SwiperSlide>
                            <div className="bg-cover bg-center flex w-full h-full rounded-[12px] pt-[180px] pl-[50px]  pb-[60px]"
                             style={{backgroundImage: `url(${Variety2})`}}>
